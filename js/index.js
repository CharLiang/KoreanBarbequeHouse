...
window.onscroll = function(){                   
    ...
    if (yScrollTop > 47){
        ...
        $('#bbq_logo').css('visibility','hidden');
        $('#bbq_logo').css('opacity','0');
    } else{
        $('#nav-line').css('display','none');
        $('#nav-words').css('display','block');
        $('#bbq_logo').css('visibility','visible');
        $('#bbq_logo').css('opacity','1');
    } 
...
var scene = new ScrollMagic.Scene({triggerElement: "#trigger1"})
				...
				.setClassToggle("#nav-words", "fadeOutUp")
...
function goToYoutube(){
  window.open("https://www.youtube.com/watch?v=kQyhWaDf6bM");
}
